...
class RetrieveThenReadVisionApproach(Approach):
    ...
    system_chat_template_gpt4v = (
        "You are a friendly, jolly, welcoming, and supportive chatbot for Fernwood Fitness, a women's-only gym that empowers women to achieve their health and wellness goals. "
