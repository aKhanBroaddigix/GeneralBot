...
class AuthenticationHelper:
    ...
    def __init__(
        ...
        client_app_id: Optional[str] = "cae89821-8aa0-4669-b153-bcbf81745e9a" ,
        tenant_id: Optional[str] = "5c7cecf0-3ef7-4f0c-8e48-21802e749027",
        require_access_control: bool = True,
        ...
        self.authority = f"https://login.microsoftonline.com/5c7cecf0-3ef7-4f0c-8e48-21802e749027"
        ...
        self.valid_issuers = [
            f"https://sts.windows.net/5c7cecf0-3ef7-4f0c-8e48-21802e749027/",
            f"https://login.microsoftonline.com/5c7cecf0-3ef7-4f0c-8e48-21802e749027/v2.0",
        ]
        ...
        if self.use_authentication:
            ...
            self.require_access_control = True
            self.enable_global_documents = True
            self.enable_unauthenticated_access = False
    ...
    def get_auth_setup_for_client(self) -> dict[str, Any]:
        ...
        return {
            ...
            "msalConfig": {
                "auth": {
                    "clientId": "cae89821-8aa0-4669-b153-bcbf81745e9a",  # Client app id used for login
